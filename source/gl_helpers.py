...
GL_UNSIGNED_INTEGER_TYPES = GLubyte, GLushort, GLuint
GL_SIGNED_INTEGER_TYPES   = GLint, GLshort, GLbyte
GL_INTEGER_TYPES  = *GL_UNSIGNED_INTEGER_TYPES, *GL_SIGNED_INTEGER_TYPES

GL_FLOATING_POINT_TYPES = GLfloat, GLdouble

GL_TYPES = *GL_INTEGER_TYPES, *GL_FLOATING_POINT_TYPES
